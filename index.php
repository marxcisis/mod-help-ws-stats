...
<html lang="en"> 
<head>
    <title>War Selection -  Documentation for modules</title>
    
    <!-- Meta -->
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Documentation For War selection module Developers">
    <meta name="author" content="MarkoLV">    
   ...
   <div class="page-content">
    ...
    <section class="cta-section text-center py-5 theme-bg-dark position-relative">
	    ...
	    <div class="container">
		    ...
		    <div class="section-intro text-white mb-3 single-col-max mx-auto">Want to launch your software project and start getting traction from your target users? Check out our premium <a class="text-white" href="#">Bootstrap 5 startup template CoderPro</a>! It has everything you need to promote your product.</div>
		    <div class="pt-3 text-center">
			    <a class="btn btn-light" href="#">Get <i class="fas fa-arrow-alt-circle-right ml-2"></i></a>
		    </div>
	    </div>
    </section><!--//cta-section-->
    ...
    <footer class="footer">
	    <div class="footer-bottom text-center py-5">
            ...
            <small class="copyright">Designed with <span class="sr-only">love</span><i class="fas fa-heart" style="color: #fb866a;"></i> by MarkoLV for developers</small>
	    </div>
    </footer>
